class UpdateHotmartAsyncJob < ApplicationJob
  queue_as :default
  ...
  header = {
    ...
    Rails.logger.debug("  ============== Iniciando RestClient .... ´´ #{token} ´´ ")
		res = RestClient.get("https://api-hot-connect.hotmart.com/reports/rest/v2/history?rows=5000", header)
